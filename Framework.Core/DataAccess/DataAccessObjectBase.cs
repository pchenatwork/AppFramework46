...
namespace Framework.Core.DataAccess
{
    ...
    /// Data Access Object
    /// </summary>
    public abstract class DataAccessObjectBase<T> : IDataAccessObject<T> where T: IValueObject
    {
        /* ==========================================================================
